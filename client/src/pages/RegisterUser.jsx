      ...
      <div className="w-full max-w-lg p-6">
        ...
        <div className="flex items-start mb-2">
          ...
          <p className="text-sm text-gray-dark ml-3">
            ...
            <a className="text-blue ml-1 underline underline-offset-2" href="/privacy-policy">
              Privacy Policy
            </a>{" "}
            and
            <a className="text-blue underline underline-offset-2 ml-1" href="/terms-and-conditions">
              Terms of Use
            </a>
            .
          </p>
